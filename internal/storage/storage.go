...
// embeddedSchemaWithVectors is used when schema.sql file is not found
const embeddedOptimizedSchema = `
-- Prompts table
...
-- -- CREATE VIRTUAL TABLE IF NOT EXISTS vec_prompts USING fts5(
--     prompt_id,
--     embedding,
--     embedding_model,
--     embedding_provider,
