...
import (
	...
	// "github.com/go-xgboost/xgboost" // TODO: Add real LambdaMART package
...
func runNightly(cmd *cobra.Command, args []string) error {
	...
	for _, group := range sessions {
		...
		// Need original input for each session - get from first interaction context
		sessionInput := "default" // TODO: Store original input with session
