...
1. **Stateless Operation**: Each command runs independently
2. **Direct Execution**: No intermediate servers or daemons
3. **File-Based Output**: Results written to disk or stdout
4. **Sequential Processing**: Commands execute one at a time
5. **Minimal Memory**: Process memory released after execution
